...
![kmunikat-anti-bot](/assets/bledy-dolaczania/komunikat-anti-bot.png)
...
3. Jeżeli dzieje się tak często, to prawdopodobnie będzie potrzebne Tobie nagranie z momentu otrzymania tego komunikatu (np. klip z medala, NVIDIA itd.).