...
> [!CAUTION] 
> Spawn jest bezpieczną strefą (Non-PvP), to już znajdziesz się w strefie PVP, gdzie gracze moga ze sobą walczyć. Uważaj na siebie!
...
Na BoxPvP są 4 zwoje, które mogą Tobie pomóc podczas rozgrywki:
...
![perki.png](../assets/skybox/perki.png)

> [!TIP]
> Walutą za która możesz zakupić perki to Dusze z graczy oraz Dolary.
...
Na trybie SkyBox jest 12 różnych talizmanów do piątego poziomu, które pomogą Tobie podczas ulepszania Twojego ekwipunku. Jeżeli chcesz otworzyć menu talizmanów, wpisz komendę (`/talizmany`):
...
- Talizman Początkującego Kopacza
...
Są 3 rodzaje sklepów na BoxPvP, aby otworzyć jego menu, wpisz komendę (`/sklep`):

- Sklep za Spędzony Czas (GENBOOST oraz MINEBOOST 2x 5min Indywidualny, KOKS Klucz 1x, VOUCHER NA RANGE VIP 30 dni 1x).
- Sklep za Coiny (Plaster miodu, Strzała, Odłamek Pryzmarynu).
- Sklep za Zabójstwa (Karta Talizmanu 1x, Kula Precyzji 1x, Serce Bossa 1x, Odłamek Zwierzakowego Klucza x1).

Prestiż może Tobie bardzo pomóc w zdobywaniu wartościowych przedmiotów, z niego możesz otrzymać. W celu otworzenia menu prestiżu wpisz (`/prestiz`):

- Kuli Precyzji 1 pkt.
- VOUCHERU NA RANGE VIP 7d 2 pkt.
- Karta Talizmanu 2 pkt.
...
Na naszej stronie znajdziesz do kupienia rangi oraz klucze, które mogą przyśpieszyć rozwijanie Twojego ekwipunku: [SKLEP KOKSCRAFT](https://kokscraft.pl/sklep/skybox).
...
| Dostęp do Bezpiecznej Strefy              |      KOKS/MVIP       |      KOKS/MVIP       |      SVIP/VIP       |     SVIP/VIP      |        TAK         |
...
| Szansa na zachowanie bloków po śmierci    |         50%          |         40%          |         30%         |        20%        |         5%         |
| Szansa na klucz w Strefie AFK             |         50%          |         40%          |         30%         |        20%        |        10%         |
| Zwiększona limit ofert w markecie do      |          30          |          20          |         15          |        10         |         5          |
...
| Dostęp do komendy `/glow`                 |         TAK          |         TAK          |         TAK         |        TAK        |         ❌          |
| Dostęp do komendy `/incognito`            |         TAK          |          ❌           |          ❌          |         ❌         |         ❌      |
